...
const clientChecks = [
  ...
  ['solicitud de acceso', '/rest/v1/platform_access_requests'],
];
...
for (const [label, marker] of functionChecks) {
...
console.log('Portal: rutas, sesión, permisos, consentimiento y administración verificados.');
